...
const styles = `
  ...
  /* Editorial masthead */
  .ma-masthead { border-bottom: 1px solid var(--ma-line); padding: 3.5rem 0 3rem; }
  .ma-masthead-grid {
    display: grid;
    grid-template-columns: 1fr;
    gap: 1rem;
  ...
  .ma-kicker::before { content: ''; width: 30px; height: 3px; background: var(--ma-red); }
  .ma-kicker span {
    font-size: 11.5px; font-weight: 800; color: var(--ma-red);
    display: block; line-height: 1.3; letter-spacing: .08em; text-transform: uppercase;
  }
  .ma-headline {
    font-family: Georgia, 'Times New Roman', serif;
    font-size: clamp(2.1rem, 4.6vw, 3.35rem);
  ...
  /* Layout */
  .ma-layout { display: grid; grid-template-columns: minmax(0, 1fr); gap: 2.5rem; }
  @media (min-width: 1024px) {
    .ma-layout { grid-template-columns: minmax(0, 760px) 300px; gap: 4rem; align-items: start; justify-content: space-between; }
    .ma-main { min-width: 0; }
    .ma-margin { width: 300px; position: sticky; top: 28px; }
  }

  /* Figure */
  .ma-figure { margin: 2rem 0 2.75rem; }
  .ma-figure-frame {
    overflow: hidden; aspect-ratio: 16 / 10; position: relative;
    background: #ece7dd; box-shadow: 0 16px 40px rgba(22,20,15,.10);
  }
  .ma-figure-link { display: block; color: inherit; }
  .ma-figure-frame img { width: 100%; height: 100%; display: block; object-fit: cover; object-position: center 28%; transition: transform .35s ease; }
  .ma-figure-link:hover .ma-figure-frame img { transform: scale(1.012); }
  .ma-figure-caption {
    display: flex; flex-wrap: wrap; justify-content: space-between; gap: 8px 18px;
    font-size: 12px; color: #777164; margin-top: 11px; padding: 0 2px;
  }
  .ma-image-credit { color: var(--ma-red); font-weight: 700; text-decoration: none; }
  .ma-image-credit:hover { color: var(--ma-red-deep); }

  /* Lede with drop cap */
  .ma-lede {
    font-family: Georgia, serif; font-size: 1.18rem; line-height: 1.58;
    color: var(--ma-ink); margin-bottom: 1.5rem;
  }
  .ma-lede-dropcap {
    float: left; font-family: Georgia, serif; font-weight: 700;
  ...
  .ma-body-text {
    font-family: Georgia, serif; font-size: 16.5px; line-height: 1.58;
    color: #2C2A24; margin-bottom: 1rem;
  }
  .ma-inline-link {
    color: var(--ma-red); text-decoration: none; font-weight: 700;
    background: rgba(175,38,46,.07); padding: .04em .22em; margin: 0 .04em;
    border-radius: 2px; box-decoration-break: clone; -webkit-box-decoration-break: clone;
  }
  .ma-inline-link::after { content: ' ↗'; font-family: Arial, sans-serif; font-size: .68em; vertical-align: .18em; }
  .ma-inline-link:hover { color: #fff; background: var(--ma-red); }

  /* Verdict strip */
  .ma-verdict {
    display: grid; grid-template-columns: 1fr;
    background: #fff; border: 1px solid var(--ma-line); border-top: 4px solid var(--ma-red);
    margin: 2rem 0 2.75rem; box-shadow: 0 10px 28px rgba(22,20,15,.06);
  }
  @media (min-width: 640px) { .ma-verdict { grid-template-columns: minmax(0, 1.5fr) minmax(210px, .75fr); } }
  .ma-verdict-cell { padding: 1.5rem 1.75rem; }
  .ma-verdict-cell.answer { background: var(--ma-red); color: #fff; display: flex; flex-direction: column; justify-content: center; }
  .ma-verdict-label {
    font-size: 11.5px; font-weight: 600; letter-spacing: 0.02em; margin-bottom: 8px;
  }
  .ma-verdict-cell.claim .ma-verdict-label { color: #8B8574; }
  .ma-verdict-cell.answer .ma-verdict-label { color: rgba(255,255,255,.72); }
  .ma-verdict-text { font-family: Georgia, serif; font-size: 16px; line-height: 1.52; color: #3A3730; }
  .ma-verdict-cell.answer .ma-verdict-text { font-size: 1.3rem; font-weight: 700; color: #fff; }

  /* Section dividers */
  .ma-section { margin-bottom: 2.65rem; scroll-margin-top: 90px; }
  .ma-section-head {
    display: flex; align-items: baseline; gap: 14px; position: relative;
    border-top: 1px solid var(--ma-line); padding-top: 17px; margin-bottom: 1.1rem;
  }
  .ma-section-head::before { content: ''; position: absolute; top: -1px; left: 0; width: 48px; height: 3px; background: var(--ma-red); }
  .ma-section-heading {
    font-family: Georgia, serif; font-size: clamp(1.15rem, 2.2vw, 1.45rem);
    font-weight: 700; color: var(--ma-ink); line-height: 1.3; margin: 0;
  }
  .ma-section.emphasis .ma-section-head { border-top-color: var(--ma-red); }
  .ma-section.emphasis .ma-section-heading { font-size: clamp(1.4rem, 3vw, 1.85rem); }
  ...
  /* Question ledger */
  .ma-ledger { border: 1px solid var(--ma-line); border-top: 3px solid var(--ma-red); margin: 1.5rem 0 1rem; background: #fff; }
  .ma-ledger-title {
    color: var(--ma-ink); padding: 14px 18px 10px;
  ...
  .ma-ledger-q { font-family: Georgia, serif; font-size: 14.5px; line-height: 1.45; color: #2C2A24; }
  ...
  /* Citations — card style */
  .ma-citations { margin: 3rem 0 2.5rem; border-top: 2px solid var(--ma-ink); padding-top: 1.25rem; scroll-margin-top: 90px; }
  .ma-citations-title { font-family: Georgia, serif; font-size: 1.35rem; font-weight: 700; color: var(--ma-ink); margin-bottom: 1rem; }
  .ma-citations-grid {
    display: grid;
    grid-template-columns: 1fr;
    gap: 14px;
  ...
  /* ── Sidebar: Table of Contents ── */
  .ma-toc {
    border: 1px solid var(--ma-line); border-top: 4px solid var(--ma-red); margin-bottom: 1.75rem; background: #fff;
  }
  .ma-toc-title {
    font-family: Georgia, serif; font-size: 1.15rem; font-weight: 700; color: var(--ma-ink);
    padding: 17px 18px 12px; border-bottom: 1px solid var(--ma-line);
  }
  .ma-toc-list { list-style: none; margin: 0; padding: 0 8px 12px; }
  .ma-toc-item { margin: 0; }
  .ma-toc-link {
  ...
  .ma-toc-num { color: var(--ma-red); font-family: Georgia, serif; font-weight: 700; flex-shrink: 0; }
  ...
  .ma-avatar img { width: 100%; height: 100%; object-fit: cover; }
  .ma-author-name { font-weight: 700; color: var(--ma-ink); font-size: 14.5px; }
  .ma-author-title { font-size: 12.5px; color: var(--ma-red); margin-top: 1px; }
  .ma-author-bio { font-size: 13px; color: var(--ma-ink-soft); line-height: 1.5; margin-bottom: 12px; }
  .ma-author-meta { font-size: 12px; color: #8B8574; border-top: 1px solid var(--ma-line); padding-top: 10px; }

  /* ── Sidebar: About this analysis ── */
  .ma-about-card { border-left: 2px solid var(--ma-ink); padding-left: 16px; }
  .ma-about-title { font-size: 12px; font-weight: 600; color: #8B8574; margin-bottom: 8px; }
  .ma-about-body { font-size: 13px; color: var(--ma-ink-soft); line-height: 1.5; }

  @media (max-width: 639px) {
    .ma-container { padding-left: 18px; padding-right: 18px; }
    .ma-masthead { padding: 2.4rem 0 2rem; }
    .ma-headline { font-size: 2rem; }
    .ma-dek { font-size: 1.05rem; line-height: 1.5; }
    .ma-figure { margin-top: 1.25rem; }
    .ma-figure-frame { aspect-ratio: 4 / 3; }
    .ma-verdict-cell { padding: 1.25rem; }
  }
`;
...
function TableOfContents({
  ...
  return (
    <nav className="ma-toc" aria-label="Table of contents">
      <div className="ma-toc-title">Table of Contents</div>
      <ul className="ma-toc-list">
        {entries.map((entry, i) => (
          <li key={entry.id} className="ma-toc-item">
            <a
        ...
        <div className="ma-container py-4 py-md-5">
          <div className="ma-layout">
            ...
            <article className="ma-main">
              ...
              <div className="ma-figure">
                <a
                  href={article.imageSourceUrl ?? "https://en.wikipedia.org/wiki/Julio_Herrera_Velutini"}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ma-figure-link"
                  aria-label="View the image source on Wikipedia"
                >
                  <div className="ma-figure-frame">
                    <Image
                      src={article.image}
                ...
                <div className="ma-figure-caption">
                  <span>{article.imageCaption ?? "Julio Herrera Velutini"}</span>
                  <a
                    href={article.imageSourceUrl ?? "https://en.wikipedia.org/wiki/Julio_Herrera_Velutini"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="ma-image-credit"
                  >
